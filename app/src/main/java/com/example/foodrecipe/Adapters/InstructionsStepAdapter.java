...
public class InstructionsStepAdapter extends RecyclerView.Adapter<InstructionStepViewHolder>{
    ...
    public void onBindViewHolder(@NonNull InstructionStepViewHolder holder, int position) {
        ...
        holder.recycler_instructions_ingredients_equipment.setHasFixedSize(true);
        holder.recycler_instructions_ingredients_equipment.setLayoutManager(new LinearLayoutManager(context, LinearLayoutManager.HORIZONTAL, false));
        ...
        holder.recycler_instructions_ingredients_equipment.setAdapter(instructionsEquipmentAdapter);
    }
...
class InstructionStepViewHolder extends RecyclerView.ViewHolder{
    ...
    RecyclerView recycler_instructions_ingredients_equipment, recycler_instructions_ingredients;
    public InstructionStepViewHolder(@NonNull View itemView) {
        ...
        recycler_instructions_ingredients_equipment = itemView.findViewById(R.id.recycler_instructions_ingredients_equipment);
