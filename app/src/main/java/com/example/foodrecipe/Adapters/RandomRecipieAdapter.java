...
public class RandomRecipieAdapter extends RecyclerView.Adapter<RandomRecipeViewHolder>{
    Context context;
    List<Recipe> list;
    RecipeClickListner listner;

    public RandomRecipieAdapter(Context context, List<Recipe> list, RecipeClickListner listner) {
...
class RandomRecipeViewHolder extends RecyclerView.ViewHolder{
    ...
    ImageView imageView_food, ic_servings, ic_like, ic_time;
